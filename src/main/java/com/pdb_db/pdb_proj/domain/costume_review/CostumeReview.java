...
@Entity
@Table
public class CostumeReview implements CostumeReviewInterface {

  @Id
  @SequenceGenerator(
          name = "costumereview_sequence",
          sequenceName = "costumereview_sequence",
          allocationSize = 1
  )
  @GeneratedValue(
          strategy = GenerationType.SEQUENCE,
          generator = "costumereview_sequence"
  )
  private Integer id;
  private String name;
  ...
  public CostumeReview(String name, String description, Integer like_reaction, Integer dislike_reaction,
  ...
  public CostumeReview(){}
  public CostumeReview(Integer id){
    this.id = id;
  }
  public CostumeReview(Integer id,
                       String name,
  ...
  public CostumeReview(String name,
                       String description,
                       Integer like_reaction,
                       Integer dislike_reaction){
    this.name = name;
